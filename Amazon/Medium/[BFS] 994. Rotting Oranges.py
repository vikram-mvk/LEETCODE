...
count total by n*m and subtract value==0 items. so that its not an empty cell
first we need to add all the rotten oranges in a queue. i.,e add all val = 2 in q
then perform BFS on the queue elements:
if an adjacent is fresh, make it rot by ==1
