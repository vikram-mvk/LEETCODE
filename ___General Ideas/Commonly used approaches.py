...
Classification:
If its easy its in easy folder
If its easy if we know the logic, then its slightly medium
If the logic itself is a little hard to remember or if its not a very simple logic, its medium
If the logic is hard and the problem is very hard to traceback or even remember the logic, its hard
...
---------------------------------------------------------------------------
DP
When an optimal sub structure and repeacting sub problems exists, try DP
